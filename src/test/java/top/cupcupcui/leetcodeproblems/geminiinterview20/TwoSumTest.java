...
import top.cupcupcui.leetcodeproblems.geminiinterview20.TwoSum;
...
public class TwoSumTest {
    ...
    public void test_PositiveCase0() {
        top.cupcupcui.leetcodeproblems.geminiinterview20.TwoSum service = new top.cupcupcui.leetcodeproblems.geminiinterview20.TwoSum();
        int[] arg1 = {2, 7, 11, 15};
        int arg2 = 9;
        int[] expected = {0, 1};
    ...
    public void test_PositiveCase4() {
        top.cupcupcui.leetcodeproblems.geminiinterview20.TwoSum service = new TwoSum();
        int[] arg1 = {0, 1, 0};
        int arg2 = 0;
        int[] expected = {0, 2};
        int[] response = service.twoSum(arg1, arg2);
